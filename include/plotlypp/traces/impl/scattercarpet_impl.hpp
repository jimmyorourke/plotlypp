...
Scattercarpet::Marker::Colorbar::Tickformatstops::Tickformatstop& Scattercarpet::Marker::Colorbar::Tickformatstops::Tickformatstop::dtickrange(std::vector<double> f) {
