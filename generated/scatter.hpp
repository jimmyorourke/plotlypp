 ...
 public:
    ...
    class Fillgradient {
     public:
        ...
        // direction specified by *orientation*, from the lowest to the highest value of the scatter plot along that
        // axis, or from the center to the most distant point from it, if orientation is *radial*.
        Fillgradient& colorscale(std::string f) {
            json["colorscale"] = std::move(f);
            return *this;
        }
        Fillgradient& colorscale(std::vector<std::pair<double, std::string>> f) {
            json["colorscale"] = std::move(f);
            return *this;
        }

        // Sets the gradient start value. It is given as the absolute position on the axis determined by the
        // orientiation. E.g., if orientation is *horizontal*, the gradient will be horizontal and start from the
        // x-position given by start. If omitted, the gradient starts at the lowest value of the trace along the
        // respective axis. Ignored if orientation is *radial*.
        Fillgradient& start(double f) {
        ...
        // E.g., if orientation is *horizontal*, the gradient will be horizontal and end at the x-position given by end.
        // If omitted, the gradient ends at the highest value of the trace along the respective axis. Ignored if
        // orientation is *radial*.
        Fillgradient& stop(double f) {
    ...
    class Fillpattern {
     public:
        ...
        Fillpattern& bgcolor(std::vector<double> f) {
            json["bgcolor"] = std::move(f);
            return *this;
        }
        ...
        Fillpattern& fgcolor(std::vector<double> f) {
            json["fgcolor"] = std::move(f);
            return *this;
        }
