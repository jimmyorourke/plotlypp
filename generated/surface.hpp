     ...
     public:
         ...
         public:
            ...
            class Project {
             public:
                ...
                // Determines whether or not these contour lines are projected on the x plane. If `highlight` is set to
                // *true* (the default), the projected lines are shown on hover. If `show` is set to *true*, the
                // projected lines are shown in permanence.
                Project& x(bool f) {
                    json["x"] = std::move(f);
                    return *this;
                }

                // Determines whether or not these contour lines are projected on the y plane. If `highlight` is set to
                // *true* (the default), the projected lines are shown on hover. If `show` is set to *true*, the
                // projected lines are shown in permanence.
                Project& y(bool f) {
                    json["y"] = std::move(f);
                ...
                // Determines whether or not these contour lines are projected on the z plane. If `highlight` is set to
                // *true* (the default), the projected lines are shown on hover. If `show` is set to *true*, the
                // projected lines are shown in permanence.
                Project& z(bool f) {
                    json["z"] = std::move(f);
            ...
            X& highlightcolor(std::string f) {
                json["highlightcolor"] = std::move(f);
                return *this;
            }
            X& highlightcolor(double f) {
                json["highlightcolor"] = std::move(f);
                return *this;
            }

            // Sets the width of the highlighted contour lines.
            X& highlightwidth(double f) {
                json["highlightwidth"] = std::move(f);
                return *this;
            }

            X& project(class Project f) {
            ...
            // An alternate to *color*. Determines whether or not the contour lines are colored using the trace
            // *colorscale*.
            X& usecolormap(bool f) {
        ...
        class Y {
         public:
            ...
            // Sets the color of the highlighted contour lines.
            Y& highlightcolor(std::string f) {
                json["highlightcolor"] = std::move(f);
                return *this;
            }
            Y& highlightcolor(double f) {
                json["highlightcolor"] = std::move(f);
                return *this;
            }

            // Sets the width of the highlighted contour lines.
            Y& highlightwidth(double f) {
                json["highlightwidth"] = std::move(f);
                return *this;
            }

            Y& project(class Project f) {
                json["project"] = std::move(f.json);
                return *this;
            }
        ...
        class Z {
         public:
            ...
            // Sets the color of the highlighted contour lines.
            Z& highlightcolor(std::string f) {
                json["highlightcolor"] = std::move(f);
                return *this;
            }
            Z& highlightcolor(double f) {
                json["highlightcolor"] = std::move(f);
                return *this;
            }

            // Sets the width of the highlighted contour lines.
            Z& highlightwidth(double f) {
                json["highlightwidth"] = std::move(f);
                return *this;
            }

            Z& project(class Project f) {
                json["project"] = std::move(f.json);
                return *this;
            }
        ...
        Contours& x(class X f) {
            json["x"] = std::move(f.json);
            return *this;
        }

        Contours& y(class Y f) {
            json["y"] = std::move(f.json);
            return *this;
        }

        Contours& z(class Z f) {
