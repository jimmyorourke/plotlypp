...
class Scatterpolar : public Trace {
 public:
    ...
    Scatterpolar& customdata(std::vector<T> f);
    ...
    Scatterpolar& hoverinfo(std::vector<std::string> f);
    ...
    Scatterpolar& hovertemplate(std::vector<std::string> f);
    ...
    Scatterpolar& hovertext(std::vector<std::string> f);
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Scatterpolar& ids(std::vector<T> f);
    ...
    template <typename T>
    Scatterpolar& meta(std::vector<T> f);
    ...
    Scatterpolar& texttemplate(std::vector<std::string> f);
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Scatterpolar& theta(std::vector<T> f);
...
class Scatterpolar::Hoverlabel {
 public:
    ...
    Scatterpolar::Hoverlabel& bgcolor(std::vector<std::string> f);
    Scatterpolar::Hoverlabel& bgcolor(std::vector<double> f);
    ...
    Scatterpolar::Hoverlabel& bordercolor(std::vector<std::string> f);
    Scatterpolar::Hoverlabel& bordercolor(std::vector<double> f);
    ...
    Scatterpolar::Hoverlabel& namelength(std::vector<int> f);
...
class Scatterpolar::Hoverlabel::Font {
 public:
    ...
    Scatterpolar::Hoverlabel::Font& color(std::vector<std::string> f);
    Scatterpolar::Hoverlabel::Font& color(std::vector<double> f);
    ...
    Scatterpolar::Hoverlabel::Font& family(std::vector<std::string> f);
    ...
    Scatterpolar::Hoverlabel::Font& lineposition(std::vector<std::string> f);
    ...
    Scatterpolar::Hoverlabel::Font& shadow(std::vector<std::string> f);

    // Sets the source reference on Chart Studio Cloud for `shadow`.
    Scatterpolar::Hoverlabel::Font& shadowsrc(std::string f);

    Scatterpolar::Hoverlabel::Font& size(double f);
    Scatterpolar::Hoverlabel::Font& size(std::vector<double> f);
    ...
    Scatterpolar::Hoverlabel::Font& weight(std::vector<int> f);
...
class Scatterpolar::Line {
 public:
    ...
    Scatterpolar::Line& backoff(std::vector<double> f);
...
class Scatterpolar::Marker {
 public:
    ...
    Scatterpolar::Marker& angle(std::vector<double> f);
    ...
    Scatterpolar::Marker& color(std::vector<std::string> f);
    Scatterpolar::Marker& color(std::vector<double> f);
    ...
    Scatterpolar::Marker& colorscale(std::vector<std::pair<double, std::string>> f);
    ...
    Scatterpolar::Marker& opacity(std::vector<double> f);
    ...
    Scatterpolar::Marker& size(std::vector<double> f);
    ...
    Scatterpolar::Marker& standoff(std::vector<double> f);
...
class Scatterpolar::Marker::Colorbar {
 public:
    ...
    // Used with `tickvals`.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Scatterpolar::Marker::Colorbar& ticktext(std::vector<T> f);
    ...
    // `ticktext`.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Scatterpolar::Marker::Colorbar& tickvals(std::vector<T> f);
...
class Scatterpolar::Marker::Colorbar::Tickformatstops::Tickformatstop {
 public:
    ...
    Scatterpolar::Marker::Colorbar::Tickformatstops::Tickformatstop& dtickrange(std::vector<std::string> f);
...
class Scatterpolar::Marker::Gradient {
 public:
    ...
    Scatterpolar::Marker::Gradient& color(std::vector<std::string> f);
    Scatterpolar::Marker::Gradient& color(std::vector<double> f);
...
class Scatterpolar::Marker::Line {
 public:
    ...
    Scatterpolar::Marker::Line& color(std::vector<std::string> f);
    Scatterpolar::Marker::Line& color(std::vector<double> f);
    ...
    Scatterpolar::Marker::Line& colorscale(std::vector<std::pair<double, std::string>> f);
    ...
    Scatterpolar::Marker::Line& width(std::vector<double> f);
...
class Scatterpolar::Textfont {
 public:
    ...
    Scatterpolar::Textfont& color(std::vector<std::string> f);
    Scatterpolar::Textfont& color(std::vector<double> f);
    ...
    Scatterpolar::Textfont& family(std::vector<std::string> f);
    ...
    Scatterpolar::Textfont& lineposition(std::vector<std::string> f);
    ...
    Scatterpolar::Textfont& shadow(std::vector<std::string> f);

    // Sets the source reference on Chart Studio Cloud for `shadow`.
    Scatterpolar::Textfont& shadowsrc(std::string f);

    Scatterpolar::Textfont& size(double f);
    Scatterpolar::Textfont& size(std::vector<double> f);
    ...
    Scatterpolar::Textfont& weight(std::vector<int> f);
