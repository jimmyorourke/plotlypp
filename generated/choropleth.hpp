...
class Choropleth : public Trace {
 public:
    ...
    std::string to_string(Locationmode e) {
        switch (e) {
        case Locationmode::ISO_3:
            return "ISO-3";
        case Locationmode::USA_STATES:
            return "USA-states";
        case Locationmode::COUNTRY_NAMES:
            return "country names";
        case Locationmode::GEOJSON_ID:
            return "geojson-id";
        }
    }
    ...
    Choropleth& transforms(class Transforms f) {
