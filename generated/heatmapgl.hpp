...
class Heatmapgl {
 public:
    ...
    Heatmapgl& autocolorscale(bool f) {
    ...
    Heatmapgl& coloraxis(std::string f) {
        json["coloraxis"] = std::move(f);
        return *this;
    }

    Heatmapgl& colorbar(class Colorbar f) {
    ...
    Heatmapgl& colorscale(std::string f) {
    ...
    Heatmapgl& customdatasrc(std::string f) {
        json["customdatasrc"] = std::move(f);
        return *this;
    }

    // Sets the x coordinate step. See `x0` for more info.
    Heatmapgl& dx(double f) {
        json["dx"] = std::move(f);
        return *this;
    }

    // Sets the y coordinate step. See `y0` for more info.
    Heatmapgl& dy(double f) {
        json["dy"] = std::move(f);
        return *this;
    }
    ...
    Heatmapgl& hoverinfo(std::string f) {
        json["hoverinfo"] = std::move(f);
        return *this;
    }
    Heatmapgl& hoverinfo(std::vector<std::string> f) {
        json["hoverinfo"] = std::move(f);
        return *this;
    }

    // Sets the source reference on Chart Studio Cloud for `hoverinfo`.
    Heatmapgl& hoverinfosrc(std::string f) {
        json["hoverinfosrc"] = std::move(f);
        return *this;
    }

    Heatmapgl& hoverlabel(class Hoverlabel f) {
    ...
    Heatmapgl& legend(std::string f) {
        json["legend"] = std::move(f);
        return *this;
    }

    Heatmapgl& legendgrouptitle(class Legendgrouptitle f) {
    ...
    Heatmapgl& legendrank(double f) {
        json["legendrank"] = std::move(f);
        return *this;
    }

    // Sets the width (in px or fraction) of the legend for this trace.
    Heatmapgl& legendwidth(double f) {
    ...
    template <typename T>
    Heatmapgl& meta(std::vector<T> f) {
        json["meta"] = std::move(f);
        return *this;
    }

    // Sets the source reference on Chart Studio Cloud for `meta`.
    Heatmapgl& metasrc(std::string f) {
        json["metasrc"] = std::move(f);
        return *this;
    }

    // Sets the trace name. The trace name appears as the legend item and on hover.
    Heatmapgl& name(std::string f) {
        json["name"] = std::move(f);
        return *this;
    }

    // Sets the opacity of the trace.
    Heatmapgl& opacity(double f) {
    ...
    Heatmapgl& reversescale(bool f) {
        json["reversescale"] = std::move(f);
        return *this;
    }

    // Determines whether or not a colorbar is displayed for this trace.
    Heatmapgl& showscale(bool f) {
        json["showscale"] = std::move(f);
        return *this;
    }

    Heatmapgl& stream(class Stream f) {
    ...
    Heatmapgl& textsrc(std::string f) {
        json["textsrc"] = std::move(f);
        return *this;
    }

    Heatmapgl& transforms(class Transforms f) {
        json["transforms"] = std::move(f.json);
        return *this;
    }

    // Transposes the z data.
    Heatmapgl& transpose(bool f) {
    ...
    // - Default: True
    Heatmapgl& visible(enum Visible f) {
    ...
    Heatmapgl& xaxis(std::string f) {
        json["xaxis"] = std::move(f);
        return *this;
    }

    // Sets the source reference on Chart Studio Cloud for `x`.
    Heatmapgl& xsrc(std::string f) {
    ...
    Heatmapgl& yaxis(std::string f) {
        json["yaxis"] = std::move(f);
        return *this;
    }

    // Sets the source reference on Chart Studio Cloud for `y`.
    Heatmapgl& ysrc(std::string f) {
    ...
    // - Default: fast
    Heatmapgl& zsmooth(enum Zsmooth f) {
        json["zsmooth"] = to_string(f);
        return *this;
    }

    // Sets the source reference on Chart Studio Cloud for `z`.
    Heatmapgl& zsrc(std::string f) {
